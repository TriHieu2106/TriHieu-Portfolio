...
const projectData = {
  malware: {
    ...
    description:
      "An information assurance analysis project focused on examining suspicious samples inside an isolated analysis environment and investigating their behavior.",
    highlights: [
